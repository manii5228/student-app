...
---------
3.the attdence section is just random class and the attendence log and dispute is not there at all
...
5.In the assignments section just show twh name of the document and remove the preview 
